...
We, as contributors and maintainers of the `bldrx` project, pledge to make participation in our community a harassment-free experience for everyone, regardless of age, body size, disability, ethnicity, gender identity and expression, level of experience, nationality, personal appearance, race, religion, or sexual identity and orientation.

We are committed to fostering an open and welcoming environment where all participants can collaborate constructively to improve `bldrx`, a CLI-first scaffold & template injector.
...
We expect all participants to respect one another and to follow applicable laws and platform terms when using tools and templates generated or applied by `bldrx`. Misuse of the tooling to facilitate harm, illegal activity, or to violate others' rights is not tolerated.
