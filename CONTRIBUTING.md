# Contributing to bldrx

Thank you for your interest in contributing to `bldrx`! We welcome contributions from the community to help improve this CLI-first scaffold & template injector. Whether you’re fixing bugs, adding features, or improving documentation, your efforts are greatly appreciated.
...
- **Respect Intellectual Property**: Contributions must comply with applicable intellectual property laws and platform terms; avoid adding content or automation that encourages piracy or unlawful activity. See `README.md` for project-specific guidance.
...
Before starting work, check the [Issues page](https://github.com/VoxDroid/bldrx/issues) and [Discussions tab](https://github.com/VoxDroid/bldrx/discussions) to see if your idea or bug has already been reported. If not, open an issue using the appropriate template:
...
1. Fork the repository by clicking the "Fork" button on this project's GitHub page: https://github.com/VoxDroid/bldrx.
2. Clone your fork to your local machine:
   ```bash
   git clone https://github.com/YOUR_USERNAME/bldrx.git
   cd bldrx
   ```
...
### Testing
- Test your changes thoroughly on your local machine across supported platforms (Windows, macOS, Linux) where possible using `pytest`.
- Ensure code and templates render and apply as expected.
...
1. Push your branch to your fork:
   ...
   ```
2. Go to the repository page (https://github.com/VoxDroid/bldrx) and click "New Pull Request."
3. Select your branch and submit the pull request using the [Pull Request template](.github/PULL_REQUEST_TEMPLATE.md). Include:
   ...
   - Testing steps and any relevant logs.
...
- Your operating system, Python version, and `bldrx` version.

## Suggesting Features
To suggest a new feature, use the [Feature Request template](.github/ISSUE_TEMPLATE/feature_request.yml) on the [Issues page](https://github.com/VoxDroid/bldrx/issues) or start a thread in the [Discussions tab](https://github.com/VoxDroid/bldrx/discussions). Include:
