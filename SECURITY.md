...
- **Alternative**: Use the [Security Report issue template](.github/ISSUE_TEMPLATE/security_report.yml) on our [Issues page](https://github.com/VoxDroid/bldrx/issues). However, we strongly recommend private reporting via email to avoid public disclosure before a fix is available.
- **Sensitive Matters**: For highly sensitive issues, you may open a private issue labeled "Security Violation" on the [Issues page](https://github.com/VoxDroid/bldrx/issues), visible only to maintainers.
...
- Always use the latest release (check the [Releases page](https://github.com/VoxDroid/bldrx/releases)).
...
## Contact
For security-related questions or follow-ups, email [izeno.contact@gmail.com](mailto:izeno.contact@gmail.com) or open a private issue labeled "Security Violation."
